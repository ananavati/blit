...
package com.luaye.console.view {
	...
	public class RollerPanel extends AbstractPanel{
		...
		private function _onFrame(e:Event):void{
			...
			if(_settingKey){
				_txtField.htmlText = "<w><menu>Press a key to set [ <a href=\"event:cancel\">cancel</a> ]</menu></w>";
			}else{
		...
		private function getMapString(dolink:Boolean = false):String{
			...
			if(!dolink){
				...
				str = "<menu> <a href=\"event:close\">X</a></menu> Capture key: <menu><a href=\"event:capture\">"+key+"</a></menu><br/>";
			}
